    ...
    <div className="HelloText">
      <svg viewBox="0 0 590 140">
        ...
        <g>
          ...
          <line className="path" id="e4" x1="150" y1="122" x2="220" y2="123" />
        </g>
        <g>
          <line className="path" id="l11" x1="260" y1="0" x2="260" y2="140" />
          <line className="path" id="l12" x1="260" y1="122" x2="330" y2="123" />
        </g>
        <g>
          <line className="path" id="l21" x1="370" y1="0" x2="370" y2="140" />
          <line className="path" id="l22" x1="370" y1="122" x2="440" y2="123" />
        </g>
        <g>
          <circle className="path" id="o" cx="510" cy="70" r="52" fill="none" />
        </g>
      </svg>
    </div>
  );
